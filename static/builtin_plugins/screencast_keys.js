...
ASPlugin.register('screencast_keys', {
	...
	onload() {
		...
		is_installed = true;
		var timeout;
		element = AS_INTERFACE.createElement('div', {id: 'screencast_keys'});
		modifier_list = AS_INTERFACE.createElement('div', {id: 'screencast_modifier_keys'}, [
			AS_INTERFACE.createElement('p', {style: 'display: none;'}, 'Ctrl'),
			AS_INTERFACE.createElement('p', {style: 'display: none;'}, 'Shift'),
			AS_INTERFACE.createElement('p', {style: 'display: none;'}, 'Alt'),
		]);
		mouse_buttons = AS_INTERFACE.createElement('div', {id: 'screencast_mouse'}, [
			AS_INTERFACE.createElement('div', {class: ''}),
			AS_INTERFACE.createElement('div', {class: ''}),
			AS_INTERFACE.createElement('div', {class: ''}),
		]);
		...
		AS_INTERFACE.preview.append(modifier_list);
		AS_INTERFACE.preview.append(element);
		AS_INTERFACE.preview.append(mouse_buttons);
		...
		Keybinding.prototype.screencastOldIsTriggered = Keybinding.prototype.isTriggered;
		Keybinding.prototype.isTriggered = function (event, ...args) {
	...
	onunload() {
		...
		setting.delete();
		style.delete();
		Keybinding.prototype.isTriggered = Keybinding.prototype.screencastOldIsTriggered;
	}
});
