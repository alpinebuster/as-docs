...
const URL = 'https://api.ai-stomatology.tech/stats/plugins?weeks=';
...
const spinningIcon = () => {
	const icon_node = AS.getIconNode('donut_large');
...
const meta = {
	...
	"icon": "trending_up",
	"author": "alpinebuster",
	"description": "View download statistics of your as plugin",
	"version": "1.3.0",
	"variant": "both",
	"tags": ["AS", "Plugins", "Development"]
}
ASPlugin.register('pluginstats', {
	...meta,
	onload() {
