...
<div id="about-content">
  <img src="/builtin_plugins/resource_pack_utilities/assets/logo.webp" />
  ...
  <ul>
    ...
    <li>
      ...
      <p>Batch Exporter is a tool that will export every asmodel file within a folder to an output folder using the selected format.</p>
    </li>
    <li>
