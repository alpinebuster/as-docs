(async function() {
    ...
    ASPlugin.register(id, {
        ...
        oninstall() {
            showAbout(true)
            AS.showQuickMessage("Successfully Installed Ground Plane Editor!");
        },
        onuninstall() {
            AS.showQuickMessage("Uninstalled Ground Plane Editor");
        },
        onload() {
            addAbout()
    ...
    function openDialog() {
        groundPlaneDialog = new Dialog("ground_plane_dialog", {
            ...
            form: {
                ...
                actions: {
                    ...
                    click() {
                        ...
                        AS.showQuickMessage("Reset ground plane values!", 1500)
                    }
                }
            },
            ...
            onConfirm(formData) {
                ...
                AS.showQuickMessage("Updated ground plane values!", 1500)
            }
        }).show()
    }
        ...
        const infoBox = new Dialog({
            ...
            lines: [`
                ...
                <div id="content">
                    ...
                    <p>This plugin is used for changing the opacity and color of the ground plane feature in AS.</p>
                    <h4>Worth noting:</h4>
                    <p>- There is currently no way to revert back to the default ground plane. However, adding this feature is planned. For now you'll have to uninstall the plugin and restart AS to revert back to the default.</p>
                    ...
                    <div class="socials">
                        <a href="${links["github"]}" class="open-in-browser">
                            <i class="fa-brands fa-github" style="color:#00acee"></i>
                            <label>By ${author}</label>
                        </a>
                        <a href="${links["chat"]}" class="open-in-browser">
                            <i class="fas fa-comment-dots" style="color:#5865F2"></i>
