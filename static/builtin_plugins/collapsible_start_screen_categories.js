(async function () {
  ...
  const links = {
    website: "https://alpinebuster.top/",
    chat: "https://alpinebuster.top/gsdfhg"
  }
  ...
  ASPlugin.register(id, {
    ...
    onload() {
      ...
      addDropDowns()
      AS.on("construct_format", addDropDowns)
      AS.on("construct_model_loader", addDropDowns)
    },
    onunload() {
      AS.removeListener("construct_format", addDropDowns)
      AS.removeListener("construct_model_loader", addDropDowns)
      aboutAction.delete()
